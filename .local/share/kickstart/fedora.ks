...
repo --name=rpmfusion-free            --baseurl=http://download1.rpmfusion.org/free/fedora/${rpmfusion_release_path:-releases}/${VERSION_ID}/Everything/x86_64/os/
repo --name=rpmfusion-free-updates    --baseurl=http://download1.rpmfusion.org/free/fedora/${rpmfusion_update_path:-updates}/${VERSION_ID}/x86_64/
repo --name=rpmfusion-nonfree         --baseurl=http://download1.rpmfusion.org/nonfree/fedora/${rpmfusion_release_path:-releases}/${VERSION_ID}/Everything/x86_64/os/
repo --name=rpmfusion-nonfree-updates --baseurl=http://download1.rpmfusion.org/nonfree/fedora/${rpmfusion_update_path:-updates}/${VERSION_ID}/x86_64/
EOF
fi
