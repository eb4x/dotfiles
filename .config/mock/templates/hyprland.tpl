# Symlinked as fedora-<rel>-x86_64-hyprland.cfg; the release comes from the
# requested root name (mock sets chroot_name before exec'ing this).
import re

_rel = re.fullmatch(r'fedora-(rawhide|\d+)-x86_64-hyprland', config_opts['chroot_name']).group(1)
...
baseurl=https://download.copr.fedorainfracloud.org/results/ebbex/hyprland/fedora-{_rel}-$basearch/
type=rpm-md
